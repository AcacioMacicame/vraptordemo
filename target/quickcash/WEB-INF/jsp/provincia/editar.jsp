                ...
                <div class="row match-height">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h3 class="card-title" id="basic-layout-form-center">Edição de Província</h3>
                                <form class="form" name="provincia" id="provincia" action="<c:url value='/provincia/edicao'/>">
                                    <div class="form-body">
                                        <div class="row">
                                            <input type="hidden" name="provincia.id" value="${provincia.id }" />

                                            <div class="col-md-5">
                                                <div class="form-group form-group-sm">
                                                    <label for="zona">Zona</label>
                                                    <select id="zona" name="provincia.zona" class="form-control form-control-sm">
                                                        <option value="${provincia.zona }" selected>${provincia.zona.description}</option>
                                        ...
                                        <table class="table table-striped table-bordered zero-configuration table-xs">
                                            ...
                                            <c:forEach items="${lista}" var="provincia">
                                                <tr class="read">
                                                    ...
                                                    <td align="center">
                                                        <a href="editar?id=${provincia.id }" title="Actualizar"><i class="la la-edit"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
